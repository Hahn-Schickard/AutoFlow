...
def StartWindow(self):
    ...
    """
    self.Window1 = UIStartWindow(self.WINDOW_WIDTH, self.WINDOW_HEIGHT,
    ...
    self.Window1.output_path_Browse.clicked.connect(
        lambda: self.get_output_path(self.Window1.output_path_label))
    self.Window1.select_model_browse.clicked.connect(
        lambda: self.get_model_path(self.Window1.model_path_label))
