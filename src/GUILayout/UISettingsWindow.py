...
class UISettingsWindow(QWidget):
    ...
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT, FONT_STYLE, task, parent=None):
        ...
        self.num_channels_label.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.num_channels.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.img_height_label.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.img_height.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.img_width_label.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.img_width.setStyleSheet("font: " + str(int(0.030*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.horizontal_box.append(QHBoxLayout())
        self.horizontal_box[7].addItem(QSpacerItem(0.09*self.WINDOW_WIDTH, 0.09*self.WINDOW_HEIGHT))
