...
class UIOptiWindow(QWidget):
    ...
    """
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT, FONT_STYLE, target,
                 parent=None):
        ...
        self.pruning.setIcon(QIcon(os.path.join(
            'src', 'GUILayout', 'Images', 'Pruning_Button.png')))
        self.pruning.setIconSize(QSize(0.35 * self.WINDOW_WIDTH,
                                       0.35 * self.WINDOW_WIDTH))
        ...
        self.pruning.setToolTip(
            'Optimize the network through pruning. This\n'
        ...
        self.quantization.setIcon(QIcon(os.path.join(
            'src', 'GUILayout', 'Images', 'Quantization_Button.png')))
        self.quantization.setIconSize(QSize(0.35 * self.WINDOW_WIDTH,
                                            0.35 * self.WINDOW_WIDTH))
        ...
        if "SBC" in self.target:
            ...
            self.quantization.setToolTip(
                'Optimize the network through quantization.\n'
        ...
        self.quantization.setStyleSheet(
            """QToolTip {
            font: """ + str(int(0.025 * self.WINDOW_HEIGHT)) + """px """ + FONT_STYLE + """;
            background-color : rgb(53, 53, 53);
            color: white;
        ...
        self.prun_acc.setToolTip(
            'The minimum accuracy of the neural network or the\n'
            'loss of accuracy that may result from pruning can\n'
            'be specified here.')
        self.prun_acc.setStyleSheet(
            """QPushButton {
            font: """ + str(int(0.025 * self.WINDOW_HEIGHT)) + """px """ + FONT_STYLE + """}
            QToolTip {
            font: """ + str(int(0.025 * self.WINDOW_HEIGHT)) + """px """ + FONT_STYLE + """;
        ...
        self.pruning_dense_label.setStyleSheet(
        ...
        self.pruning_conv_label.setStyleSheet(
            "font: " + str(int(0.025 * self.WINDOW_HEIGHT)) + "px " +
            FONT_STYLE)
        ...
        self.pruning_dense.setStyleSheet(
            "font: " + str(int(0.035 * self.WINDOW_HEIGHT)) + "px " +
            FONT_STYLE)
        ...
        self.pruning_conv.setStyleSheet(
            "font: " + str(int(0.035 * self.WINDOW_HEIGHT)) + "px " +
            FONT_STYLE)
        ...
        self.prun_acc_label.setStyleSheet(
            "font: " + str(int(0.025 * self.WINDOW_HEIGHT)) + "px " +
            FONT_STYLE)
        ...
        self.prun_acc_edit.setStyleSheet(
            "font: " + str(int(0.035 * self.WINDOW_HEIGHT)) + "px " +
            FONT_STYLE)
        ...
        self.quant_int.setToolTip(
            'This quantization approach converts all weights\n'
            'to int8 values. But the input and output still\n'
            'remain 32-bit float.')
        self.quant_int.setStyleSheet(
            """QPushButton {
            font: """ + str(int(0.025 * self.WINDOW_HEIGHT)) + """px """ + FONT_STYLE + """}
            QToolTip {
            font: """ + str(int(0.025 * self.WINDOW_HEIGHT)) + """px """ + FONT_STYLE + """;
        ...
        self.horizontal_box.append(QHBoxLayout())
        self.horizontal_box[2].addItem(QSpacerItem(
            self.WINDOW_WIDTH, 0.02 * self.WINDOW_HEIGHT))
