...
class UIOptiWindow(QWidget):
    ...
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT, FONT_STYLE, target, parent=None):
        ...
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 0, 1, alignment=Qt.AlignBottom)
        sublayout.addWidget(self.gap_label, 0, 1, Qt.AlignBottom)
        sublayout.addWidget(self.prun_acc, 0, 2, Qt.AlignBottom)
        # sublayout.addItem(QSpacerItem(0.15*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 0, 3, alignment=Qt.AlignBottom)
        sublayout.addWidget(self.gap, 0, 3, Qt.AlignBottom)
        sublayout.addWidget(self.quant_int, 0, 4, Qt.AlignBottom)
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 0, 5, alignment=Qt.AlignBottom)
        ...
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 1, 1, alignment=Qt.AlignCenter)
        ...
        # sublayout.addItem(QSpacerItem(0.15*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 1, 3, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap, 1, 3, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 1, 4, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 1, 4, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 1, 5, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap_label, 1, 5, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 1, 6, alignment=Qt.AlignCenter)
        ...
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 2, 1, alignment=Qt.AlignCenter)
        ...
        # sublayout.addItem(QSpacerItem(0.15*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 2, 3, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap, 2, 3, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 2, 4, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 2, 4, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 2, 5, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap_label, 2, 5, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 2, 6, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 2, 6, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 3, 0, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 3, 0, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 3, 1, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap_label, 3, 1, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 3, 2, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 3, 2, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.15*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 3, 3, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap, 3, 3, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 3, 4, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.button_placeholder, 3, 4, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.025*self.WINDOW_WIDTH, 0.05*self.WINDOW_HEIGHT), 3, 5, alignment=Qt.AlignCenter)
        sublayout.addWidget(self.gap_label, 3, 5, Qt.AlignCenter)
        # sublayout.addItem(QSpacerItem(0.12*self.WINDOW_WIDTH, 0.07*self.WINDOW_HEIGHT), 3, 6, alignment=Qt.AlignCenter)
