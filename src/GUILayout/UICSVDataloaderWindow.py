...
class UICSVDataloaderWindow(QWidget):
    ...
    def __init__(self, WINDOW_WIDTH, WINDOW_HEIGHT, FONT_STYLE, parent=None):
        ...
        self.cb_tab.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.label_dec.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.dec_label_col.setStyleSheet("font: " + str(int(0.03*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.cb_semicolon.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        sublayout3.addItem(QSpacerItem(0.201*self.WINDOW_WIDTH, 0.04*self.WINDOW_HEIGHT))
        sublayout3.addStretch()
        layout.addLayout(sublayout3)

        self.cb_comma = QCheckBox('Comma', self)
        self.cb_comma.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.tot_row.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.num_row = QLabel()
        self.num_row.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.cb_space.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.tot_col.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.num_col = QLabel()
        self.num_col.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
        ...
        self.cb_other.setStyleSheet("font: " + str(int(0.032*self.WINDOW_HEIGHT)) + "px " + FONT_STYLE)
