...
def image_classifier(project_name, output_path, data_path, max_trials=10,
                     max_epochs=20, max_size=0, overwrite=True, num_channels=3,
                     img_height=128, img_width=128, separator=None,
