...
class UIOptiWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.label.setFont(QFont("Optimization", 12))
        ...
        self.quant_float.setFont(QFont("float16", 10))
        ...
        self.quant_int.setFont(QFont("int8", 10))
        ...
        self.Dis_1_label.setFont(QFont("Dis_1_label", 10))
        ...
        self.Dis_2_label.setFont(QFont("Dis_2_label", 10))
        ...
        self.Huf_1_label.setFont(QFont("Huf_1_label", 10))
        ...
        self.Huf_2_label.setFont(QFont("Huf_2_label", 10))
