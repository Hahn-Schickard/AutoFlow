...
float* model_execute(float input_data[32]) { //the inputdata is a parameter
 
  // Place the inputdata in the model's input tensor as one dimensional input.
  // In this case there is time series with 32 timesteps.
  for(int i = 0; i < 32; i++) {	// i = number of timesteps
